...
@Command(scope = "onos", name = "show-vlans-on-port")
public class ShowVlansOnPortCommand extends AbstractShellCommand {
	...
	protected void execute() {
		...
		print(forwarder.devices().get(deviceId).showHashMapContents(portId, "port"));
	}
}
